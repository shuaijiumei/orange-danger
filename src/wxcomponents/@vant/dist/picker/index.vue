<template>
<uni-shadow-root class="@vant-dist-picker-index"><view class="van-picker custom-class">
...
global['__wxRoute'] = '@vant/dist/picker/index'
...
export default global['__wxComponents']['@vant/dist/picker/index']
</script>

<template>
<uni-shadow-root class="@vant-dist-tree-select-index"><view class="van-tree-select" :style="'height: '+(utils.addUnit(height))">
...
global['__wxRoute'] = '@vant/dist/tree-select/index'
...
export default global['__wxComponents']['@vant/dist/tree-select/index']
</script>
